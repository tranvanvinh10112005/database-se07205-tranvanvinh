    ...
    public partial class History : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                var makh = selectedRow.Cells["makh"].Value.ToString();
                var masp = int.Parse(selectedRow.Cells["masp"].Value.ToString());
                var date = int.Parse(selectedRow.Cells["date"].Value.ToString());
                var soluong = int.Parse(selectedRow.Cells["soluong"].Value.ToString());
                var trangthai = int.Parse(selectedRow.Cells["trangthai"].Value.ToString());
